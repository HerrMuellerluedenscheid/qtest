...
try:
    ...
    import pickle
'''{'q': 0.094188365758785114, 'event1': <qtest.sources.DCSourceWid object at
 0x7fd4c7050be0>, 'td': 1875.4923075715485, 'snr1': 25.671509, 'target':
 <pyrocko.gf.targets.Target object at 0x7fd4ab2414e0>, 'totald':
 10301.983523752433, 'pd': 340.58347460133115, 'rmse': 0.10328656169950369,
 'rsquared': 0.77178789450064877, 'snr2': 55.453697, 'incidence':
 7.4748259117506137, 'event2': <qtest.sources.DCSourceWid object at
 0x7fd4c723efd0>, 'cc': 0.89884726787060842},
'''
...
with open(fn, 'rb') as f:
    ...
    for i in ii:
        print('event: %s  Nmeasures: %s  median: %s  std: %s' % (e[i], nqs[i],
                                                                 qs_by_event[i],
                                                                 std_by_event[i]))
    ...
    fig.savefig('covariances.png', dpi=400)
    # plt.show()

# distances muss eine liste sein und diese auch akzeptieren
defaults = {'source_depth': 1.0,
            'receiver_depth': 0.000,
            'sw_equidistant': 1,
            'sw_d_unit': 0,
            'no_distances': 31,
            'distances': 60.0,
...
print """# This is the input file of FORTRAN77 program "qseis06" for calculation of
...
#------------------------------------------------------------------------------
 ...
 {sw_equidistant}  {sw_d_unit}                  |int: sw_equidistant, sw_d_unit;
 {no_distances}                    |int: no_distances;
 {distances}             |dble: d_1,d_n; or d_1,d_2, ...(no comments in between!);
 {t_start}  {t_window} {no_t_samples}     |dble: t_start,t_window; int: no_t_samples;
 {sw_t_reduce}  {t_reduce}                |int: sw_t_reduce; dble: t_reduce;
#------------------------------------------------------------------------------
#
...
taken finally for the sublayer thickness.""".format(**defaults)
